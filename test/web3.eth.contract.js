...
describe('web3i.eth.contract', function() {
    it('should create simple contract with one method from abi with explicit type name', function() {
        ...
        // when
        var web3i = new Web3i();
        var myCon = web3i.eth.contract(description).at(address);
    ...
    it('should create contract with nondefault constructor', function(done) {
        ...
        web3i.eth.contract(description).new(2, { from: address, data: code }, function(e, myCon) {
            done();
            web3i.stopWatching();
        });
    });
