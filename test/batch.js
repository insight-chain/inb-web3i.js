...
describe('lib/web3i/batch', function() {
    describe('execute', function() {
        it('should execute batch request', function(done) {
            ...
            var batch = web3i.createBatch();
            batch.add(web3i.eth.getBalance.request('0x0000000000000000000000000000000000000000', 'latest', callback));
            batch.add(web3i.eth.getBalance.request('0x0000000000000000000000000000000000000005', 'latest', callback2));
            batch.execute();
        });
        ...
        it('should execute batch request for async properties', function(done) {
            ...
            var batch = web3i.createBatch();
            batch.add(web3i.eth.getAccounts.request(callback));
            batch.add(web3i.net.getPeerCount.request(callback2));
            batch.execute();
        });
        ...
        it('should execute batch request with contract', function(done) {
            ...
            var batch = web3i.createBatch();
            batch.add(web3i.eth.getBalance.request('0x0000000000000000000000000000000000000000', 'latest', callback));
            batch.add(web3i.eth.contract(abi).at(address).balance.request(address, callback2));
            provider.injectBatchResults([result, result2]);
            batch.execute();
        });
